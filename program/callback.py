...
3.) **بعد أضافتي ورفعي ادمن قم بكتاابة امر /reload او امر تحديث.**
3.) **قم بإضافة @{ASSISTANT_NAME} الي مجموعتك او استخدم امر /userbotjoin للإضافة تلقائيا. او ارسل انضم**
...
» /تشغيل (لتشغيل اغنيه في المحادثه الصوتيه (اسم الاغنيه / الرابط)
» /فيديو (لتشغيل فيديو في المحادثه الصوتيه (اسم فيديو / الرابط)
» /vstream رابط البث الحي + الجوده 720 360 480
» /القائمة - لعرض قائمة التشغيل
» /تحميل ف (اسم الفديو) - تحميل فيديو من يوتيوب
» /تنزيل (اسم الاغنيه) - تحميل اغنيه من يوتيوب
» /كلمات (اغنيه) - جلب كلمات اغنيه
» /بحث (الفديو/ الاغنيه) - للبحث علي اليوتيوب
...
» /تخطي - لتخطي الاغنيه
» /توقف - لايقاف الاغنيه
» /كتم - لكتم البوت في المحادثة الصوتية
» /رفع الكتم - لالغاء كتم البوت في المحادثة الصوتية
» /volume `1-200` - التحكم في صوت البوت (يجب ان يكون البوت الماساعد مشرف)
» /تحديث - تحديث البوت وتحديث قائمة الادمنية
» /انضم - لدعوة البوت المساعد
» /غادر - لخروج البوت المساعد
